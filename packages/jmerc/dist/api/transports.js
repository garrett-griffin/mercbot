...
var _require = require('../models/transport'),
  Transport = _require.Transport,
  TransportRoute = _require.TransportRoute;
...
var TransportsAPI = /*#__PURE__*/function (_BaseAPI) {
  function TransportsAPI() {
    return _BaseAPI.apply(this, arguments) || this;
  }
  _inheritsLoose(TransportsAPI, _BaseAPI);
  TransportsAPI.rootUrl = function rootUrl() {
   ...
   */;
  var _proto = TransportsAPI.prototype;
  _proto.get =
  /*#__PURE__*/
  function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return _BaseAPI.prototype.get.call(this, TransportsAPI.rootUrl() + "/" + id);
          case 3:
            response = _context.sent;
            return _context.abrupt("return", Transport.modelValidate(response));
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            throw new Error("Failed to fetch transport with ID " + id + ": " + _context.t0.message);
          case 10:
          case "end":
